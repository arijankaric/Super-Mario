...
//Object goomba;
//Object ground;
Object initial_ground;

Object *initial_ground_first = new Object();
Object *initial_ground_second = new Object();
Object *initial_ground_third = new Object();
Object *death_ground = new Object();
                    ...
                    int nCmdShow)
{
    ...
    while (TRUE)
    {
        ...
        while(GetTickCount()- vrijeme_pocetak < 55)
        {
            Sleep(5);
        }
    }
...
void UpdateObjekat(HWND hwnd, RECT* rect) // Checking for interactions
{
    ...
    {
        if(distanceBetweenObjects(mario, *el) > 75)
        {
            continue;
        }
...
//        (mario.x < (el->x + 2)) && (mario.x > (el->x - 20)) && (testMarioY == (el->y+6))
        ...
        else if((el->typeOfObject == QUESTIONMARK) && ((mario.x + mario.leftSide) == (el->x + el->rightSide)) && (((mario.y + mario.bottomSide) < (el->y + el->bottomSide)) && ((mario.y + mario.bottomSide) > (el->y + el->topSide)) || ((mario.y + mario.topSide) <= (el->y + el->bottomSide)) && ((mario.y + mario.topSide) > (el->y + el->topSide))) && (dx < 0))
        {
            std::cout << "----------------------------------\n";
        ...
        else if((el->typeOfObject == FLOWER_ENEMY) && ((mario.x + mario.rightSide) == (el->x + el->leftSide)) && (((mario.y + mario.bottomSide) < (el->y + el->bottomSide)) && ((mario.y + mario.bottomSide) > (el->y + el->topSide)) || ((mario.y + mario.topSide) <= (el->y + el->bottomSide)) && ((mario.y + mario.topSide) > (el->y + el->topSide))) && (dx > 0))
        {
            std::cout << "----------------------------------\n";
        ...
        else if((el->typeOfObject == FLOWER_ENEMY) && ((mario.x + mario.leftSide) == (el->x + el->rightSide)) && (((mario.y + mario.bottomSide) < (el->y + el->bottomSide)) && ((mario.y + mario.bottomSide) > (el->y + el->topSide)) || ((mario.y + mario.topSide) <= (el->y + el->bottomSide)) && ((mario.y + mario.topSide) > (el->y + el->topSide))) && (dx < 0))
        {
            std::cout << "----------------------------------\n";
...
//            foreground.x -= mario.dx;
        ...
        hbmMarioWalk = hbmMarioWalkLeft;
        hbmMarioWalkMask = hbmMarioWalkLeftMask;
        if(mario.objectY != 3)
        {
            mario.objectX++;
            if(mario.objectX == 2)
